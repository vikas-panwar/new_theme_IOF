...
<script type="text/javascript">
    ...
    function fetchGraphData(condition = null) {
        ...
        $.ajax({
            ...
            data: {reportType: reportType, type: type, orderType: orderType, startDate: startDate, endDate: endDate, month: month, year: year, fromYear: fromYear, toYear: toYear, pageNo: pageNo, merchantOption: merchantOption, itemId: itemId, date_start_from: date_start_from, date_end_from: date_end_from, coupon_code: coupon_code, promo_id: promo_id, extended_offer_id: extended_offer_id},
    ...
    function fetchPaginationData(page = null, sort = null, sort_direction = null) {
        ...
        $.ajax({
            ...
            data: {reportType: reportType, orderType: orderType, type: type, merchantOption: merchantOption, itemId: itemId, startDate: startDate, endDate: endDate, month: month, year: year, fromYear: fromYear, toYear: toYear, date_start_from: date_start_from, date_end_from: date_end_from, coupon_code: coupon_code, promo_id: promo_id, extended_offer_id: extended_offer_id, page: page, sort: sort, sort_direction: sort_direction},
            success: function (result) {
