<div class="modal-dialog inner-wrap clearfix">
    ...
    <div class="modal-title hc vc">Add Address<button aria-label="Close" data-dismiss="modal" class="close" type="button">
        ...
        <?php if ($label1 != 1) { ?>
            <div id="label1">
                ...
                <div id='home_block'>
                    ...
                    <div class="profile-input clearfix">
                        <label3>Zip-Code<em>*</em></label3>
                        <div class="col-right">
                            <div class="col-width">
                                <?php echo $this->Form->input('DeliveryAddress.zipcode', array('type' => 'text', 'class' => 'user-detail', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true)); ?>
                            </div>
                        </div>
                    </div>
                    <div class="profile-input clearfix">
                        <label3>Phone Number<em>*</em></label3>
                        <div class="col-right">
                            <div class="col-width">
            ...
            <div id="label2">
                ...
                <div id='work_block'>
                    ...
                    <div class="profile-input clearfix">
                        ...
                        <div class="col-right">
                            <div class="col-width">
                                <?php echo $this->Form->input('DeliveryAddress1.zipcode', array('type' => 'text', 'class' => 'user-detail', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true)); ?>
                            </div>
                        </div>
                    </div>
                    <div class="profile-input clearfix">
            ...
            <div id="label3">
                ...
                <div id='other_block'>
                    ...
                    <div class="profile-input clearfix">
                        ...
                        <div class="col-right">
                            <div class="col-width">
                                <?php echo $this->Form->input('DeliveryAddress2.zipcode', array('type' => 'text', 'class' => 'user-detail', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true)); ?>
                            </div>
                        </div>
                    </div>
                    <div class="profile-input clearfix">
            ...
            <div id="label4">
                ...
                <div id='address4_block'>
                    ...
                    <div class="profile-input clearfix">
                        ...
                        <div class="col-right">
                            <div class="col-width">
                                <?php echo $this->Form->input('DeliveryAddress3.zipcode', array('type' => 'text', 'class' => 'user-detail', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true)); ?>
                            </div>
                        </div>
                    </div>
                    <div class="profile-input clearfix">
                        ...
                        <div class="col-right">
                            <div class="col-width">
                                ...
                                <div class="col-2"><?php echo $this->Form->input('DeliveryAddress3.phone', array('data-mask' => 'mobileNo', 'type' => 'text', 'class' => 'user-detail phone-number', 'placeholder' => 'Phone Number', 'label' => false, 'div' => false, 'required' => true)); ?></div>
                                <span>(eg. 111-111-1111)</span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="label5">
                ...
                <div id='address5_block'>
                    ...
                    <div class="profile-input clearfix">
                        ...
                        <div class="col-right">
                            <div class="col-width">
                                <?php echo $this->Form->input('DeliveryAddress4.zipcode', array('type' => 'text', 'class' => 'user-detail', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true)); ?>
                            </div>
                        </div>
                    </div>
                    <div class="profile-input clearfix">
    ...
    <div class="confirm-andy">
        <div class="submit">
            ...
            <?php }else{?>
            <?php
            echo $this->Form->button('Submit', array('type' => 'submit', 'class' => 'submitAddAddress hc uc button f18 bgcolor_focus w260'));
            echo $this->Form->button('Cancel', array('type' => 'button', 'class' => 'closeModal hc uc button f18 bgcolor_default w260'));
            ?>
            <?php }?>
        </div>
    </div>
