                        ...
                        <tr <?php echo $class; ?>>	    
                            ...
                            <td>
                                ...
                                if($data['Order']['coupon_code'] != null)
                                {
                                    ...
                                    echo $this->Html->link($coupon_amount, array('controller' => 'payments', 'action' => 'orderDetail', $EncryptOrderID)) . '<br/>';
                                    $showcount++;
                                }
                            ...
                            <td><?php echo $this->Common->amount_format(($data['OrderPayment']['amount'] - $data['Order']['coupon_discount'])); ?></td>
