...
<div class="location common-padding">
    ...
    <!--                        <img src="/img/hq/contact-map.jpg" alt="full-article">-->
                        ...
                        <div class="address-card">
                            ...
                            <div class="address-btn">
                                ...
                                <?php if (!empty($stores['StoreSetting']['merchant_online_order_btn'])) { ?>
                                    ...
                                    <!--                                                   
                                <?php } ?>
        <!--                                <a class="contact-btn" target='blank' href='http://<?php echo $stores['Store']['store_url']; ?>'>ORDER ONLINE</a>-->
                            </div>
                        </div>
                        <hr class="border-fix">
                    </div>
...
<?php if (!empty($store)) { ?>
    ...
    <script type="text/javascript">
        var zoomLevel = <?php echo $logoPosition['MerchantConfiguration']['map_zoom_level']; ?>;
        var style = [
            {
