...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'reports', 'action' => 'moneyReport','id'=>'one')));  ?>
	...
	<?php echo $this->Form->input('Segment.id',array('type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'autocomplete' => 'off','options'=>$typeList,'empty'=>'Order Type')); ?>		
                ...
                <div class="col-lg-1">	
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <?php echo $this->Html->link('Download Excel', array('controller'=>'reports','action'=>'moneyReportDownload',$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$ordertype),array('class' => 'btn btn-default')); ?>
                </div>
           </div></div>
        <?php echo $this->Form->end();?>
          ...
          <?php  echo  $this->element('report/dollar/index') ; ?>
    </div>
</div>
