...
$amntdate = ''; $amnt = '' ; $tamnt = 0 ;
    if($type == 1){       
       echo $this->element('/report/order/daily');
    }elseif($type == 2){
        //echo "In progress";
       echo $this->element('/report/order/weekly'); 
    }elseif($type == 3){
       echo $this->element('/report/order/monthly'); 
    }elseif($type == 4){
       echo $this->element('/report/order/yearly'); 
    }elseif($type == 5){
       echo $this->element('/report/order/life_time'); 
    } 
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?php echo $this->Form->create('Report', array('url' => array('controller' => 'reports', 'action' => 'orderReport','id'=>'one')));  ?>
	...
	<?php echo $this->Form->input('Segment.id',array('type'=>'select','class'=>'form-control valid','label'=>false,'div'=>false,'autocomplete' => 'off','options'=>$typeList,'empty'=>'Order Type')); ?>		
                ...
                <div class="col-lg-1">	
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    <?php echo $this->Html->link('Download Excel', array('controller'=>'reports','action'=>'orderReportDownload',$type,$startdate,$enddate,$Month,$Year,$yearFrom,$yearTo,$ordertype),array('class' => 'btn btn-default')); ?>
                </div>
           </div></div>
...
<div class="row">
    ...
    <div class="col-sm-6 text-right">
        <?php echo $this->Paginator->counter('showing {:current} records out of {:count} total'); ?> 
          ...
          <?php  echo  $this->element('report/order/index') ; ?>
