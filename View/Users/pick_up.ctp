...
<div class="content single-frame">
    <div class="wrap">
        ...
        ?>
        <div class="clearfix">
            <section class="form-layout sign-up fullwidth">
...
<?php 
    ...
    ?>		
                    <div class="radio-btn space20 delivery-address-option">
                        <input type="radio"  id="pre-order" name="data[DeliveryAddress][type]" checked value="1" /> <label for="pre-order"><span></span>Pre Order</label>
                    </div>   
    <?php } }else { ?>
                    <div class="radio-btn space20 delivery-address-option">
                        <?php if($nowAvail){?>
                        <input type="radio"  id="now" name="data[DeliveryAddress][type]" checked value="0" /><label for="now"><span></span>Now</label>
    <?php if($PreorderAllowed){  ?>
    
                        <input type="radio"  id="pre-order" name="data[DeliveryAddress][type]" value="1" /> <label for="pre-order"><span></span>Pre Order</label>
<?php } ?>
    <?php } ?>
                    </div>   
    <?php } 
