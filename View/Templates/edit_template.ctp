<?php echo $this->Html->script('ckeditor/ckeditor');?>
    ...
    <div class="row">
	   ...
	   <div class="form-group form_margin">
		...
		<?php echo $this->Form->input('EmailTemplate.template_subject',array('type'=>'text','class'=>'form-control valid','placeholder'=>'Enter Type','label'=>'','div'=>false));
                  echo $this->Form->error('EmailTemplate.template_subject');
  ...
  'default'=>1
            ...
            <?php echo $this->Html->link('Cancel', "/templates/index/", array("class" => "btn btn-default",'escape' => false)); ?>
        </div>
