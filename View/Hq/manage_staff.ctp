<style>
    ...
    @media (max-width:860px) { .new-chkbx-wrap { width:33.333%; }  }
    @media (max-width:540px) { .new-chkbx-wrap { width:50%; }  }
    @media (max-width:420px) { .new-chkbx-wrap { width:100%; }  }
</style>
<div class="row">
    <div class="col-lg-6">
        <?php
...
<div class="row">
    <div class="col-lg-9">
        ...
        if (!empty($this->request->data['User']['id'])) {
            echo $this->Html->link('Cancel', "/hq/manageStaff", array("class" => "btn btn-default", 'escape' => false));
        }
        ?>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="table-responsive">   
                <?php echo $this->Form->create('Store', array('url' => array('controller' => 'hq', 'action' => 'manageStaff'), 'id' => 'AdminId', 'type' => 'get')); ?>
                <div class="row padding_btm_20">
                    ...
                    <div class="col-lg-4">                        
                        ...
                        <?php echo $this->Html->link('Clear', array('controller' => 'hq', 'action' => 'manageStaff'), array('class' => 'btn btn-default')); ?>
                    </div>
                    <!--                <div class="col-lg-4">    
                                        <div class="addbutton">                
...
<script>
    ...
    $("#StoreKeyword").autocomplete({
                    source: "<?php echo $this->Html->url(array('controller' => 'hq', 'action' => 'getSearchValues')); ?>",
                    minLength: 3,
...
if (!isset($this->request->data['User']['id'])) {
    ?>
                        ...
                        remote: "/hq/checkMerchantEmail/<?php echo $roleId; ?>/"
