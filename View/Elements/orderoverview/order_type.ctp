            ...
            <div class="panel-body nested-ac">
                <div class=" pay-wrap select-order clearfix">
                    <div class="pay-select clearfix">
                        <span class="clearfix chk-span">
                        <?php if ($store_data_app['Store']['is_delivery'] == 1) { ?>
                                <input type="radio" id="test1" name="data[Order][type]" value="3" class="order_type">
                                <label for="test1"><span class="chk-span"></span>Delivery</label>
                        <?php } if ($store_data_app['Store']['is_take_away'] == 1) { ?>
                                <input type="radio" id="test2" name="data[Order][type]" value="2" class="order_type">
                                <label for="test2"><span class="chk-span"></span>Pick-up</label>
                            <?php
                        }
                        ?>
                        </span>
                    ...
                    <div class="theme-btn-group">
                        <?php
                        echo $this->Form->button('Save', array('type' => 'button', 'class' => 'saveOrderType btn button-color1 button-size5'));
                        ?>
                    </div>
                </div>
            </div>
