...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php echo $this->Form->create('User', array('id' => 'chkOrderUserLogin', 'class' => "sign-up", 'url' => array('controller' => 'users', 'action' => 'popuplogin'), 'autocomplete' => 'off')); ?>
            ...
            <div class="hidden-xs col-sm-4 vc hc " style="height:90px;">
                <?php echo $this->Form->input('SUBMIT', array('type' => 'button', "class" => "button w100p h100p btn-lg bgcolor_focus", 'id' => 'btnUserLoginM', 'label' => false, 'div' => false)); ?>
            </div>
            <div class="visible-xs col-xs-12 vc hc button">
                <?php echo $this->Form->input('SUBMIT', array('type' => 'button', "class" => "button w100p h100p btn-lg bgcolor_focus", 'id' => 'btnUserLogin', 'label' => false, 'div' => false)); ?>
            </div>
            <div class="col-xs-12 left error" style="display:none;" id="poperror">Invalid email or password, please try again</div>
                <div class="col-xs-12 tc" style="padding : 10px 0;">
                <?php
                $chek = '';
                if (!empty($rem)) {
                $chek = 'checked';
                ...
                &nbsp; | &nbsp;
                <label><?php echo $this->Html->link('Forgot Password?', array('controller' => 'users', 'action' => 'forgetPassword'), array('class'=>'')); ?></label>
            </div>
...
<?php } else { ?>
    <div class="bgcolor_white modal-dialog clearfix">
        ...
        <?php } ?>
        <?php echo $this->Form->create('User', array('id' => 'chkOrderUserLogin', 'class' => "sign-up", 'url' => array('controller' => 'users', 'action' => 'popuplogin'), 'autocomplete' => 'off')); ?>
        <div class="input-wrap clearfix theme-btn-group">
            <div class="input-fields btn-group">
                <?php echo $this->Form->input('User.email', array('type' => 'email', "placeholder" => "Enter Your Email", 'autofocus' => true, 'label' => false, 'maxlength' => '50', "class" => "inputlogin sign-input", 'div' => false, 'id' => 'UserLoginEmail', 'value' => @$userEmail)); ?>
                <?php echo $this->Form->input('User.password', array("placeholder" => "Enter Your Password", 'label' => false, 'type' => 'password', 'div' => false, 'maxlength' => '20', "class" => "inputlogin sign-input", 'value' => @$userPassword)); ?>
            </div>
            <div class="sign-up-btn">
                <?php echo $this->Form->input('SUBMIT', array('type' => 'button', "class" => "m20 button-color1 button-size6", 'id' => 'btnUserLogin', 'label' => false, 'div' => false)); ?>
            </div>
        </div>
        <p><?php
            $chek = '';
        ...
        <div class="left error" style="display:none;" id="poperror">Invalid email or password, please try again</div>
        <div class="reg-btn">
            <?php echo $this->Html->link('Sign Up', array('controller' => 'users', 'action' => 'registration'), array('escape' => false, 'class' => "sign-up-custom button-color2 button-size7")); ?>
        </div>
        <?php echo $this->Form->end(); ?>
    </div>
<?php } ?>
<script>
    ...
    $(document).ready(function () {
        $('#btnUserLogin, #btnUserLoginM').click(function (e) {
