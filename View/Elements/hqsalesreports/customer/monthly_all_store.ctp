    ...
    if($graphPageNumber == 0)
    {
        ...
        if(isset($customerType) && $customerType == 5)
        {
            ...
            if (isset($graphDataAll))
            {
                ...
                foreach($graphDataAll['Store'][0] as $amount){
        ...
        if (!empty($aData) && !empty($datee)) 
        {
            ...
            if(isset($customerType) && $customerType == 5)
            {
                $text = '<style="font-size:12px;">Monthly Report for</style> <br/><style="font-size:14px;">Merchant</style><br/><style="font-size:12px;">'.date('M',strtotime($year . '-' . $month . '-01')) . '-' . $year . '</style>';
            }
            else 
            {
                $text = '<style="font-size:12px;">Monthly Report for</style> <br/><style="font-size:14px;">HQ</style><br/><style="font-size:12px;">'.date('M',strtotime($year . '-' . $month . '-01')) . '-' . $year . '</style>';
            }
