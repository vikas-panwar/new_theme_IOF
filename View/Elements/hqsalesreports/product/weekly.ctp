...
$subTitle = '<style="font-size:14px;font-weight:bold;">Total '.$totalItems.' Item </style>';
                    ...
                    drilldown: {                        
                        ...
                        foreach($graphdata['daywise'] as $key => $innerGraphdata)
                        {
                            if($splinestring==''){
                                ...
                                $splinestring.=","; 
                                $splinestring.=(isset($innerGraphdata['totalorders']))?$innerGraphdata['totalitems']:0;
...
<div id="pagination_data_request">
    <?php echo $this->element('hqsalesreports/product/pagination'); ?>
</div>
