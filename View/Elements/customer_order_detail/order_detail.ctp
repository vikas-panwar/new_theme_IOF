        ...
        <table class="table table-bordered table-hover table-striped tablesorter">
            ...
            <tbody class="dyntable">
                <?php foreach ($orderDetails as $oData) { ?>
                    <tr>
                        <td><?php echo $this->Html->link($oData['Order']['order_number'], array('controller' => @$this->params['controller'], 'action' => 'customerOrderDetail', $this->Encryption->encode($oData['Order']['id']))); ?></td>
                        <td><?php echo number_format($oData['Order']['amount'] - $oData['Order']['coupon_discount'], 2); ?></td>
