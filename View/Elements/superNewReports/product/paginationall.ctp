...
<!--                        <th  class="th_checkbox">Store Name</th>-->
            ...
            if(!empty($order)){
                ...
                <tr>  
                    <td>
                        <?php echo  $this->Html->link($data['Order']['order_number'],array('controller'=>'super','action'=>'customerOrderDetail',$EncryptOrderID)); ?>
                    ...
                    <td>
                        ...
                        else if(isset($data['Order']['User']['fname']) && !empty($data['Order']['User']['fname']))
                        {
			...
			?>
                    ...
                    <td>
                        <?php echo (isset($data['Order']['tip']) ? number_format($data['Order']['tip'], 2) : '0.00'); ?>
                    </td>
                    <td>
                        <?php
