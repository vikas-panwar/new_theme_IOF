...
<div class="radio-btn space20 delivery-address-option payoptioncls">
    <?php if ($store_result['Store']['is_pay_by_credit_card'] == 1 && $store_result['Store']['api_username'] != '' && $store_result['Store']['api_password'] != '' && !empty($storeSetting['StoreSetting']['is_creditcard_allow']) && $finalAmount > 0) { ?>
    ...
    <?php if (AuthComponent::User() || ($store_result['Store']['guest_user'] == 1 && $store_result['Store']['guest_user_cod'] == 1)) { ?>
        <?php if ($store_result['Store']['cash_on_delivery'] == 1) { ?>
            <input type="radio" id='payment2' name="payment" value=3 class="cod" /> <label for="payment2" class="common-bold"><span></span>Cash on Delivery</label>
        <?php } ?>
    <?php } ?>

    <?php if ($store_result['Store']['is_express_check_out'] == 1 && $store_result['Store']['paypal_email'] != '' && $store_result['Store']['paypal_password'] != '' && $store_result['Store']['paypal_signature'] != '' && !empty($storeSetting['StoreSetting']['paypal_allow']) && $finalAmount > 0) { ?>
        <input type="radio" id='express-check-out' name="payment" value=2 class="express-check-out" /> <label for="express-check-out" class="common-bold"><span></span>PayPal Express</label>
    <?php } ?>

    <?php if ($store_result['Store']['is_pay_by_credit_card'] == 1 && $store_result['Store']['api_username'] != '' && $store_result['Store']['api_password'] != '' && $finalAmount > 0) {
        ?>
        </br></br>
...
<?php if ($finalAmount > 0) { ?>
    <ul id='credit_payment1' class="clearfix">
        <li>
            ...
            <div class="title-box">
                ...
                ?>
                <?php echo $this->Form->input('Payment.creditype', array('options' => $rType, 'type' => 'select', 'id' => "CardType", 'class' => 'inbox', 'label' => false, 'div' => false)); ?>
            </div>
        </li>
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('cardnumber', array('id' => 'CardNumber',
                    'type' => 'text', 'class' => 'inbox', 'label' => false, 'div' => false,
        ...
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('cvv', array('id' => 'CVV', 'type' => 'text',
                    'class' => 'inbox', 'label' => false, 'div' => false, 'placeholder' => 'Enter CVV'));
                ?>
            </div>
        </li>
        <?php
        ...
        ?>
        <li>
            <span class="title"><label>Expiration Date <em>*</em></label></span>

            <div class="title-box"><?php
                echo $this->Form->input('expiryMonth', array('type' => 'select', 'class' =>
                    'inbox country-code', 'label' => false, 'div' => false, 'options' => $month));
                ?>
                <?php echo $this->Form->input('expiryYear', array('type' => 'select', 'class' => 'inbox
                    country-code', 'label' => false, 'div' => false, 'options' => $year)); ?>
            </div>
        </li>
    </ul>
    ...
    <ul id='credit_payment2' class="clearfix">
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('firstname', array('id' => 'first_name', 'type' => 'text', 'class' => 'inbox', 'label' => false, 'div' => false, 'placeholder' => 'Enter First Name'));
        ...
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('lastname', array('id' => 'last_name', 'type' => 'text', 'class' => 'inbox', 'label' => false, 'div' => false, 'placeholder' => 'Enter Last Name'));
        ...
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('address', array('id' => 'address', 'type' => 'text', 'class' => 'inbox', 'label' => false, 'div' => false, 'placeholder' => 'Enter Address'));
        ...
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('city', array('id' => 'City', 'type' => 'text', 'class' => 'inbox', 'label' => false, 'div' => false, 'placeholder' => 'City'));
        ...
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('state', array('id' => 'State', 'type' => 'text', 'class' => 'inbox', 'label' => false, 'div' => false, 'placeholder' => 'State'));
        ...
        <li>
            ...
            <div class="title-box"><?php
                echo $this->Form->input('zipcode', array('id' => 'Zipcode', 'type' => 'text', 'class' => 'inbox', 'label' => false, 'div' => false, 'placeholder' => 'Zip-Code', 'maxlength' => '5'));
                ...
                <div class="input-field clearfix">
                    ...
                    if ($customer_vault_id) {
                        echo $this->Form->input('update_vault', array('type' => 'checkbox',
                            'label' => array('text' => 'Update NZ Safe credit card with the information above.', 'style' => 'padding-top:2px;'), 'checked' => 'checked'));
                    } else {
                        echo $this->Form->input('update_vault', array('type' => 'checkbox',
                            'label' => array('text' => 'Store this credit card information to NZ Safe.', 'style' => 'padding-top:2px;'), 'checked' => 'checked'));
                    }
                    ?>
                    <div class="clr"></div>
                </div>
...
<div class="clr"></div>
<div class="payment-options other-option text-center clearfix">	    
    <?php
    if ($store_result['Store']['is_express_check_out'] == 1 || $store_result['Store']['is_pay_by_credit_card'] || $store_result['Store']['cash_on_delivery']) {
        echo $this->Form->button('Proceed to Payment', array('type' => 'submit', 'class' => 'btn green-btn pink-btn makePayment'));
    }
    echo $this->Form->button('Continue Shopping', array('type' => 'button', 'onclick' => "window.location.href='/products/items/$encrypted_storeId/$encrypted_merchantId'", 'class' => 'btn green-btn pink-btn'));
    ?>
</div>
...
<?php if ($finalAmount > 0) { ?>
    ...
    <div class="payment-options check-out-option text-center clearfix">	   

        <!-- ===== Express check-out Payment Button ===== -->
        <?php
        echo $this->Form->button('Express checkout', array('type' => 'button', 'class' => 'btn green-btn pink-btn makeExpCheckout makePayment'));
//            echo $this->Html->link('Express checkout', array('controller' => 'payments', 'action' => 'express_checkout'), array('class' => 'btn green-btn pink-btn makePayment'));
        echo $this->Form->button('Continue Shopping', array('type' => 'button', 'onclick' => "window.location.href='/products/items/$encrypted_storeId/$encrypted_merchantId'", 'class' => 'btn green-btn pink-btn'));
        ?>
        <!-- ===== Express check-out Payment Button End===== -->
    </div>
<?php } ?>
<!-- ===== Express check-out form End ===== -->

<!-- ##### Payment method types End ##### -->    
<script>
