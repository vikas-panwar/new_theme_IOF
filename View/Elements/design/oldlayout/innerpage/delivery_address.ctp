<?php ?>
<style>
#delivery_address .form-group { width:100%;float:left;margin-bottom:10px;}
#delivery_address .form-inner-action-btn a { margin-left:16px;}
#pickupdata #resvTime { float:left;margin-left:1px;}
#pickupdata #resvTime .time-setting label { font-size:15px;line-height:14px;margin-top:5px;}
#pickupdata #resvTime .time-setting select.input { padding:7px;}
</style>
<div class="content single-frame">
    <div class="wrap">
        ...
        <?php if (!empty($checkaddress) && ($this->Session->check('Order.order_type'))) { ?> 
            ...
            <div class="clearfix">
                <section class="form-layout sign-up clearfix">
