<header class="bottom-header theme-bg-2">
    <?php if (KEYWORD == 'IOF-D3-V') { ?>
        <div class="white-bg">
            <div class="main-container">
                <div class="log-in-header clearfix">
                    <div class="log-head-right">
                        <div class="pull-left lhr-lft">
                            <a href="javascript:void(0);" class="menu-control"><i class="glyphicon glyphicon-menu-hamburger"></i></a>
                            <a href="/users/login"><?php echo $this->Html->image('/storeLogo/' . $store_data_app['Store']['store_logo']); ?></a>
                        </div>
...
<script>
    ...
    {
        var container = $(".main-header-menu");
