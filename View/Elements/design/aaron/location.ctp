                ...
                <?php if (!empty($displayContactUsForm['StoreSetting']['display_contact_us_form'])) { ?>
                    <div class="message-form clearfix">
                        ...
                        <div class="form-group row"><label class="col-sm-3 col-form-label">Mobile Phone<em>*</em></label>
                            <div class="col-sm-9">
                                <?php echo $this->Form->input('StoreInquiries.phone', array('data-mask' => 'mobileNo', 'type' => 'text', 'class' => 'form-control pad-left-30', 'placeholder' => 'Enter your phone', 'label' => false, 'div' => false)); ?>
                            </div></div>
