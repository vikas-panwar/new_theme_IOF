            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title" rel='<?php echo $store_id; ?>' id='<?php echo $id_name; ?>' category_id='<?php echo $list['Category']['id']; ?>' size-type='<?php echo $list['Category']['is_sizeonly']; ?>'><a data-toggle="collapse" data-parent="#accordion1"                                            href="<?php echo "#collapseTwo" . $k; ?>" title="<?php echo $mText; ?>">
                            ...
                            <span class="arrow-down theme-arrow-down"></span>
                            <?php echo $mStar; ?>
                        </a>
                    </h4>
                </div>
                                            ...
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    ...
                                                    <span class="pos-right">
                                                        ...
                                                        <?php echo $this->Html->link('<i class="glyphicon glyphicon-plus-sign"></i>', 'javascript:void(0)', array('escape' => false, 'class' => 'itemprop', 'rel' => $item_id, 'id' => $id_name, 'store_id' => $store_id, 'item_parent_id' => $category_id, 'size-type' => $list['Category']['is_sizeonly'])); ?>
                    <!--                                                        <a class="item_link parent_category_id5617" rel="44376" id="item_id44376" store_id="134" item_parent_id="5617" size-type="<?php echo $list['Category']['is_sizeonly'] ?>" data-toggle="collapse" data-parent="#accordion2" href="<?php echo '#collaspe' . $k . $j; ?>"><i class="glyphicon glyphicon-plus-sign"></i></a>-->
                                                    </span>
                                                </h4>
                                            </div>
                                                    ...
                                                    <div class="inner-menu">
                                                        ...
                                                        <div class="price clearfix">
                                                            ...
                                                            if (empty($listItem['offerDisplay']) && empty($listItem['ItemOfferDisplay'])) {
                                                                ...
                                                                echo $this->Html->link('ADD', 'javascript:void(0)', array('class' => 'add-menu button-color1 button-size2 itemprop parent_category_id' . $category_id, 'rel' => $item_id, 'id' => $id_name, 'store_id' => $store_id, 'item_parent_id' => $category_id, 'size-type' => $list['Category']['is_sizeonly']));
                                                            }
                                                            ?>
                                                        </div>
                                                        ...
                                                        <div class="menu-offer-wrap">
                                                            ...
                                                            if (!empty($listItem['offerDisplay']) || !empty($listItem['ItemOfferDisplay'])) {
                                                                ...
                                                                echo $this->Html->button('ADD', 'javascript:void(0)', array('class' => 'button-color1 button-size2 ' . $category_id, 'rel' => $item_id, 'id' => $id_name, 'store_id' => $store_id, 'item_parent_id' => $category_id, 'size-type' => $list['Category']['is_sizeonly']));
                                                            }
                                                            ?>
                                                        </div>
                ...
                <!--                                                        <span class="price-q">
                                                    ...
                                                    <div class="menu-offer-wrap">
                                                        ...
                                                        <?php
                                                        if (!empty($listItem['offerDisplay']) || !empty($listItem['ItemOfferDisplay'])) {
                                                            echo $this->Html->link('ADD', 'javascript:void(0)', array('class' => 'add-menu button-color1 button-size2 itemdrop parent_category_id' . $category_id, 'rel' => $item_id, 'id' => $id_name, 'store_id' => $store_id, 'item_parent_id' => $category_id, 'size-type' => $list['Category']['is_sizeonly']));
                                                        }
                                                        ?>
                                                    </div>
                                                </div>
