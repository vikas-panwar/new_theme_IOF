...
<div class="my-order">
    ...
    if (isset($final_cart) && !empty($final_cart)) {
        ?>
        <div class="coupon-code-box clearfix">
            <h4>Coupon Code</h4>
            <div class="overview-container">
                <div class="overview-left">
                    <?php if (isset($_SESSION['Coupon'])) { ?>
                        <input class="cp-code-input error-coupon" type="text" name="coupon code" placeholder="" value='<?php echo $_SESSION['Coupon']['Coupon']['coupon_code']; ?>'/>
                    <?php } else { ?>
                        <input class="cp-code-input error-coupon" type="text" name="coupon code" placeholder="" />
                    <?php } ?>
                </div>
                <div class="overview-middle"></div>
                <div class="overview-right">
                    <input type="button" value="Apply" id="couponApply" class=" button-color4 button-size2">
                </div>
            </div>
            <?php
                        ...
                        <div class="item-1 clearfix">
                            ...
                            <div class="input-group spinner">
                                <div class="in-spinner">
                                    <button type="button" class="btn pull-right quantity" key="<?php echo $session_key; ?>"><i aria-hidden="true" class="glyphicon glyphicon-plus-sign"></i></button>
                                    ...
                                    <button type="button" class="btn  pull-left quantity" key="<?php echo $session_key; ?>"><i aria-hidden="true" class="  glyphicon glyphicon-minus-sign"></i></button>
                                </div>
                            </div>
                        </div>
                    </li>
                ...
                <?php if ($gross_amount && isset($_SESSION['Coupon'])) { ?>
                    <li>
                        <div class="total-price clearfix">
                            ...
                            <?php echo $this->Html->link('<i class="glyphicon glyphicon-remove"></i>', array('controller' => 'products', 'action' => 'removeCoupon'), array('escape' => false, 'confirm' => 'Are you sure to remove coupon?')); ?>
                        </div>
                    </li>
                <?php } ?>
                <?php
    ...
    <?php
        ...
        if(!empty($guestUserDetail) || !empty($logined) ) {

            echo '
            <div class="continue theme-btn-group">
                <div id="desktop_continue">
                    <input type="submit" value="CONTINUE" class="btn button-color1 button-size1" />
                </div>
                <div id="mobile_continuemenu">
                    <input type="button" value="Continue to menu" class="btn button-color1 button-size1" />
                </div>
                <div id="mobile_continue">
                    <input type="submit" value="Continue to Payment" class="btn button-color1 button-size1" />
                </div>
            </div>';

        } else {
            echo '<div class="continue theme-btn-group">Please sign in or proceed as a guest</div>';
        }
    ?>
</div>
...
<style>
    ...
    [data-tooltip]:after {
        ...
        border-right: 5px solid transparent;chulgil.lee@ebankcardservice.com
