...
echo $this->Form->create('Payment', array('controller' => 'payments', 'action' => 'paymentSection', 'onsubmit' => 'return creditForm();'));
?>
...
<?php if ($finalAmount > 0) { ?>
    ...
    <div class="pay-option check-out-option1">
        ...
        <div class="card-detail pay-date-o" id='credit_payment1'>
            ...
            <div class="card-input exp-date clearfix">
        ...
        <div class="card-detail pay-date-o" id='credit_payment2'>                        
            <div class="card-input">
                        ...
                        <div class="input-field clearfix">
                            ...
                            if ($customer_vault_id) {
                                echo $this->Form->input('update_vault', array('type' => 'checkbox',
                                    'label' => array('text' => 'Update NZ Safe credit card with the information above.', 'style' => 'padding-top:7px;'), 'checked' => 'checked'));
                            } else {
                                echo $this->Form->input('update_vault', array('type' => 'checkbox',
                                    'label' => array('text' => 'Store this credit card information to NZ Safe.', 'style' => 'padding-top:7px;'), 'checked' => 'checked'));
                            }
                            ?>
                            <div class="clr"></div>
                        </div>
