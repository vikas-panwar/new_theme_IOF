                        ...
                        foreach ($order as $key => $data) {
                            ...
                            <tr>
                                ...
                                if ($data['Order']['seqment_id'] == 2) {
                                    ...
                                    echo $this->Dateform->us_format($this->Common->storeTimezone('', $data['Order']['pickup_time']));
                                }
                                if ($data['Order']['seqment_id'] == 3) {
                                    if ($data['Order']['is_pre_order'] == 0) {
                                        //$deliveryTime = $this->Dateform->us_formatwithTime($this->Common->storeTimezone('', $data['Order']['created']));
                                          echo $this->Dateform->us_format($this->Common->storeTimezone('', $data['Order']['pickup_time']));
                                    } else {
                                         echo $this->Dateform->us_format($this->Common->storeTimezone('', $data['Order']['pickup_time']));
                                    }
                                ...
                                <td><?php
                                    ...
                                    //echo $this->Dateform->us_format($data['Order']['created']);
                                    ?></td>
