...
<!--                        <th  class="th_checkbox">Store Name</th>-->
		  ...
		  <?php
			...
			echo  $this->Html->link("History",array('controller'=>'superreports','action'=>'orderHistory',$EncryptUserID,substr($urldata[0],0,10),substr($urldata[1],0,10),$urldata[2],$page,$data['User']['store_id'],$data['User']['merchant_id']));
			?></td>
