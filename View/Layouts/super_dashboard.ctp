        ...
        <div id="wrapper" class="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">        
                <div class="navbar-header">        
                    ...
                    <div class="logoimg"><a href="/super/dashboard" style="color:#FFFFFF;text-decoration: none;">Welcome to Super Admin</a></div> 
                </div>
                    <?php echo $this->element('admin/super'); ?>
            </nav>
            <div id="page-wrapper">
            	<div class="container">
                <!-- Bread Crumb -->
            ...
            <?php 
            if($this->Session->read('Auth.Super.role_id')){
