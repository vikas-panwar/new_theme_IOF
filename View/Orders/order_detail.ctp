...
$total_amount = $orderDetail[0]['Order']['amount'] - $orderDetail[0]['Order']['coupon_discount'];
...
<script type="text/javascript">
    $("#OrderUpdateOrderStatusForm").closest('form').on('submit', function (e) {
        e.preventDefault();
        var radioValue = $('input[name="data[Order][order_status_id]"]:checked', '#OrderUpdateOrderStatusForm').val();
